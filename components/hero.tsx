        ...
        >
            ...
            >
                ...
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 mb-8">
                    ...
                    <span className="text-sm font-medium text-white/90">Est. 2020 • Pune</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link
                        href="/contact"
                        className="btn btn-lg px-8 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/30 text-white hover:bg-white hover:text-black hover:border-white transition-all duration-300"
                    >
                        Contact Us
                    </Link>
                </div>
